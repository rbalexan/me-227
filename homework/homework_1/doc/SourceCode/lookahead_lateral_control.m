function [delta, K_la, d_la, e_la] = lookahead_lateral_control(e_m, dpsi_rad, K_1pm, veh)
%LOOKAHEAD__LATERAL__CONTROL 
%   This function calculates the desired steering angle for the vehicle to track a path
%
%   Inputs
